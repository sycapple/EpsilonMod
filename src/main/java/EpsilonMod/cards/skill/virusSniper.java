...
public class virusSniper extends abstractEpsilonCard {
    public static final String ID = epsilonModHelper.makeID(virusSniper.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new addUnitToPileAction(new virusSniperUnit(), this.magicNumber));
    }
}