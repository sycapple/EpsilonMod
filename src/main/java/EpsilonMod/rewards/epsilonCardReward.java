...
public class epsilonCardReward extends CustomReward {
    private static final String[] TEXT;
    public int amount;

    public epsilonCardReward() {
        super(ImageMaster.REWARD_CARD_NORMAL, TEXT[2], abstractEpsilonRewardsEnum.EPSILON_CARD_REWARD);
        ...
        this.type = abstractEpsilonRewardsEnum.EPSILON_CARD_REWARD;
